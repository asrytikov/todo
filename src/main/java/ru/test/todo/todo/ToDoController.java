...
public class ToDoController {
    ...
    public ResponseEntity<?> createToDo(@Validated @RequestBody ToDo toDo, Errors errors){
        if (errors.hasErrors()){
            return ResponseEntity.badRequest().body(ToDoValidationErrorBuider.fromBindingErrors(errors));
        }
